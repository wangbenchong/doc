...
参考：https://github.com/SleeplessOwl0102/URP-Custom-Post-Processing
...
还是以屏幕置灰效果为例，将刚刚的代码填写完整如下（顺便再改个脚本名）：
...
namespace SleeplessOwl.URPPostProcessing.CEditor
{
    ...
    public class PostProcessOrderConfigEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            afterSkybox = Util_ReorderableList.CreateAutoLayout(afterSkyboxProp, "After Skybox");
            ...
            beforePost = Util_ReorderableList.CreateAutoLayout(beforePostProp, "Before Post-Process");
            ...
            afterPost = Util_ReorderableList.CreateAutoLayout(afterPostProp, "After Post-Process");
...
```mermaid
graph LR
Assets--> Create --> S[SleepLess Owl] --> POC[PostProcess Order Config]
```
